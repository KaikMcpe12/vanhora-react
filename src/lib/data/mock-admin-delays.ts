...
export const MOCK_ADMIN_DELAYS: AdminDelay[] = [
  ...
  { id: 'delay-003', routeCode: 'X-09', routeName: 'Express Aeroporto', cooperativeId: 'coop-expresso', cooperativeName: 'Expresso São Francisco', delayMinutes: 22, reason: 'Acidente de trânsito bloqueando a BR-116.', severity: 'high', reportedBy: 'Carlos Lima', reportedAt: h(3), status: 'pending' },
  ...
  { id: 'delay-006', routeCode: 'R-305', routeName: 'Centro-Sul', cooperativeId: 'coop-expresso', cooperativeName: 'Expresso São Francisco', delayMinutes: 10, reason: 'Passageiro com dificuldade de mobilidade.', severity: 'low', reportedBy: 'Felipe Costa', reportedAt: h(8), status: 'resolved', resolvedAt: h(5) },
  ...
  { id: 'delay-011', routeCode: 'N-07', routeName: 'Noturna Sul', cooperativeId: 'coop-expresso', cooperativeName: 'Expresso São Francisco', delayMinutes: 35, reason: 'Pane elétrica no veículo. Substituição necessária.', severity: 'high', reportedBy: 'Ricardo Alves', reportedAt: d(3), status: 'resolved', resolvedAt: d(3) },
  ...
  { id: 'delay-015', routeCode: 'X-09', routeName: 'Express Aeroporto', cooperativeId: 'coop-expresso', cooperativeName: 'Expresso São Francisco', delayMinutes: 45, reason: 'Bloqueio policial na BR-116 por mais de 1 hora.', severity: 'high', reportedBy: 'Carlos Lima', reportedAt: d(5), status: 'resolved', resolvedAt: d(5) },
  ...
  // Último mês
  { id: 'delay-019', routeCode: 'R-402', routeName: 'Centro - Norte', cooperativeId: 'coop-expresso', cooperativeName: 'Expresso São Francisco', delayMinutes: 25, reason: 'Greve parcial na garagem causou atraso na saída.', severity: 'medium', reportedBy: 'João Silva', reportedAt: d(10), status: 'resolved', resolvedAt: d(10) },
  ...
  { id: 'delay-023', routeCode: 'N-07', routeName: 'Noturna Sul', cooperativeId: 'coop-expresso', cooperativeName: 'Expresso São Francisco', delayMinutes: 6, reason: 'Sinalização confusa causou percurso incorreto.', severity: 'low', reportedBy: 'Ricardo Alves', reportedAt: d(20), status: 'resolved', resolvedAt: d(20) },
