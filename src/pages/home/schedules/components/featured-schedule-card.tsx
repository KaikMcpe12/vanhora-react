...
export function FeaturedScheduleCard({
  ...
  return (
    ...
    >
      {/* ── bloco principal ── */}
      <div className="px-6 pt-[22px] pb-0 space-y-4">
        ...
        {/* linha 2: route line (cidades maiores via override) */}
        <div>
          <RouteLine
        ...
        {/* linha 3: rodapé com meta + preço */}
        <div className="flex items-center justify-between gap-3 border-t border-border/40 pt-3.5 pb-[18px]">
          {/* cooperativa */}
              ...
              {schedule.cooperativeRating && (
                <span className="text-[11px] text-muted-foreground font-mono">
                  ...
                  {schedule.cooperativeReviews && (
                    <span className="ml-1">· {schedule.cooperativeReviews.toLocaleString('pt-BR')} avaliações</span>
                  )}
                </span>
              )}
            </div>
      ...
      <div className="flex items-center justify-between border-t border-border/40 px-6 py-2.5">
        <button
          ...
          className="flex cursor-pointer items-center gap-1.5 text-[12px] font-medium text-muted-foreground transition-colors hover:text-foreground"
        ...
        >
          ...
          />
          {expanded ? 'Fechar itinerário' : 'Ver itinerário'}
        </button>
      ...
      >
        <div className="overflow-hidden">
          <div className="space-y-4 border-t border-border/40 px-6 pt-4 pb-5">
            ...
            <RouteTimeline stops={stops} cooperativeColor={cooperativeColor} />
